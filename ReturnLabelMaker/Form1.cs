    ...
    public partial class ReturnsForm : Form
    {
        ...
        private void buttonGenerate_Click(object sender, EventArgs e)
        {
                ...
                && comboBoxLocation.SelectedItem != null && textBoxPhone.TextLength == 10) //Catch sending errors to FedEx server
            {
                ...
                authRequest.AddParameter("client_id", ""); 
                authRequest.AddParameter("client_secret", "");
        ...
        private void linkLabelKb_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e) //Open knowledge base article on click
        {
            Process.Start(new ProcessStartInfo("https://shsupport.jitbit.com/helpdesk/KB/View/52757660-it-returns-label-maker") { UseShellExecute = true });
        }
    }
}
